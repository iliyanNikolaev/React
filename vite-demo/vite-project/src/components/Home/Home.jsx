...
export default function Home() {
    return (
        <div className='home-page'>
            ...
            <p><i class="fas fa-exclamation-triangle"></i> This is an application made for demonstration purposes.</p>
            <h3 className='home-title'><i class="fas fa-code"></i> Build with:</h3>
